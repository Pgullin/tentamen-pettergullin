...
export const Uppgift2 = () => {
	...
	const [myMagnificentValue, setmyMagnificentValue] = useState("The magnificient value")

	return (
		<div>
			<h1>Uppgift 2</h1>
			<h2>{myMagnificentValue}</h2>
			<input placeholder="Denna input skall uppdatera värdet som matas in till ditt state" onChange={event => setmyMagnificentValue(event.target.value)} />
		</div>
	)
}
